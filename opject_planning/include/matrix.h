...
enum class MiniCheetahType { ORIGIN, LINKAGE, LINKAGE_2, BELT_1, BELT_2, VERIFY, KODA_1_5, KODA_2_0, KODA_2_0_SIM, UNITREE_A1 };

const MiniCheetahType gMiniCheetahType = MiniCheetahType::LINKAGE_2;
